...
if (!$other || !can_message($pdo, $userId, $otherUserId)) {
    ...
    redirect('/faculty/messages.php');
}

// Non-JS fallback: plain POST send.
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    require_csrf('/faculty/conversation.php?user=' . $otherUserId);
    ...
    redirect('/faculty/conversation.php?user=' . $otherUserId);
}
...
<?php require __DIR__ . '/../includes/faculty_sidebar.php'; ?>
    <main class="dashboard-main">
        <?php render_flashes(); ?>
        <a href="<?= e(url('/faculty/messages.php')) ?>" class="d-inline-block mb-2" style="color:var(--uiu-blue);"><i class="bi bi-arrow-left"></i> Back to Messages</a>
        ...
        <div class="app-panel">
            ...
            <form id="chatForm" action="<?= e(url('/faculty/conversation.php?user=' . $otherUserId)) ?>" method="post" class="d-flex gap-2 mt-3">
                <?= csrf_field() ?>
