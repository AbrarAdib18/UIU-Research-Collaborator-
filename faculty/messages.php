    ...
    <main class="dashboard-main">
        ...
        <div class="app-panel">
            <?php if (!$conversations): ?>
                <div class="app-empty-state"><i class="bi bi-chat-dots"></i><p>No conversations yet. Accept a connection or advisor request to start messaging.</p></div>
            <?php else: foreach ($conversations as $c): ?>
                <a class="conv-row" href="<?= e(url('/faculty/conversation.php?user=' . $c['other_id'])) ?>">
